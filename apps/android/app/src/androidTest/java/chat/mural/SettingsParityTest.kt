...
class SettingsParityTest {
    ...
    @Test fun groupedSettingsKeepKeyAdvancedAndRestoreSubtitleLanguageAndMinutePreferences() {
        ...
        compose.onNodeWithTag("settings-learning-language-fr").assertDoesNotExist()
        compose.onNodeWithTag("settings-learning-language-de").performScrollTo().performClick()
        compose.runOnIdle { assertEquals("de", vm.archive.preferences.learningLanguageID) }
